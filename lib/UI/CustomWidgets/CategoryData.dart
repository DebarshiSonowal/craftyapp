                ...
                child: Column(
                  children: [
                    CarouselSlider(
                      ...
                      items: data.getAdImage().map((i) {
                        return Builder(
                          builder: (BuildContext context) {
                            return GestureDetector(
                              onTap: () => widget
                                  .showIndex(data.getAdImage().indexOf(i)),
                              child: Container(
                    ...
                    Row(
                      ...
                      children: data.getAdImage().map((url) {
                        int index = data.getAdImage().indexOf(url);
                        return Container(
                          width: 5.0,
                          height: 3.0,
            ...
            Card(
              ...
              child: Container(
                ...
                child: ListView.builder(
                  ...
                  itemCount: data.getCateg().length,
